...
const Comment = ({ commentText, commentPic, name, position }) => {
  return (
    <div className="flex flex-col items-start justify-center w-3/4 gap-10 p-8 mx-auto rounded-2xl bg-slate-800 h-80 lg:h-96 lg:p-20">
      ...
      <div className="flex items-center justify-center gap-4">
        ...
        <div>
          <h1 className="mb-2 text-sm font-semibold text-third-color font-TitrPlus">{name}</h1>
